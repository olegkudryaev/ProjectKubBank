...
-- changeset liquibase:2
    ...
    INSERT INTO public."Tasks" ("id", "title", "description", "time", "status", "performer")
    VALUES ('e6ef0910-1c81-11ee-be56-0242ac120002', 'Task title3', 'Task description3', '2023-07-23 12:00:00', 'In progress', null);
    INSERT INTO public."Tasks" ("id", "title", "description", "time", "status", "performer")
    VALUES ('4774719e-1c82-11ee-be56-0242ac120002', 'Task title4', 'Task description4', '2023-07-28 12:00:00', 'In progress', null);
